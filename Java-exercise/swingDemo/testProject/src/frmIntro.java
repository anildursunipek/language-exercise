...
public class frmIntro extends javax.swing.JFrame {
    ...
    public frmIntro() {
        ...
        lstTime.setModel(lstModel);
        tblTime.setModel(tblModel);
    }
    ...
    private void initComponents() {
        ...
        lstTime.setModel(new javax.swing.AbstractListModel<String>() {
        ...
        if (tblTime.getColumnModel().getColumnCount() > 0) {
            tblTime.getColumnModel().getColumn(0).setResizable(false);
            tblTime.getColumnModel().getColumn(1).setResizable(false);
            tblTime.getColumnModel().getColumn(3).setResizable(false);
            tblTime.getColumnModel().getColumn(4).setResizable(false);
        }
    ...
    private javax.swing.JList<String> lstTime;
